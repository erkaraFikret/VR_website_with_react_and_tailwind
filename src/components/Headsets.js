...
const Headsets = () => {
  return <section className='py-12 lg:py-24'>
    <div className='container mx-auto'>
      <h2 className='text-3xl font-bold mb-6 text-center' data-aos="fade-down" data-aos-offset="300">Mixed Reality Headsets</h2>
      <div className='grid gap-y-4 lg:grid-cols-2 lg:gap-9'>
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1000">
          ...
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold tex-xl mb-2'>Metaverse</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea cupiditate, temporibus illo voluptate id illum!
            </p>
          </div>
        </div>
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1300">
          ...
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold tex-xl mb-2'>AIoT</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea cupiditate, temporibus illo voluptate id illum!
            </p>
          </div>
        </div>
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1600">
          <img src={Headset1} alt="" />
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold tex-xl mb-2'>HoloLens</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea cupiditate, temporibus illo voluptate id illum!
            </p>
          </div>
        </div>
        <div className='relative' data-aos="zoom-in" data-aos-offset="300" data-aos-delay="1900">
          <img src={Headset1} alt="" />
          <div className='absolute bottom-0 bg-white/20 backdrop-blur-md max-w-[300px] min-h-[150px] p-6'>
            <h4 className='font-semibold tex-xl mb-2'>TPCASTT</h4>
            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Ea cupiditate, temporibus illo voluptate id illum!
            </p>
          </div>
        </div>
